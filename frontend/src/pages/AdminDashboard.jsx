  ...
  return (
    <div className="px-4 pt-7">
      <NavLink
        ...
        className="mt-10 bg-blue-500 text-white p-4 rounded-full shadow hover:bg-blue-700 "
      >
        Créer un utilisateur
      </NavLink>
      {users.map((user) => (
        <div key={user.id} className="bg-white p-4 rounded-lg shadow my-4">
          ...
          {showModal && (
            <>
              <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed mx-10 inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                      <h3 className="text-xl text-center font-semibold">
                        Voulez vous vraiment supprimer {user.firstname}{" "}
                        {user.lastname} ?
                      </h3>
                      <button
                        type="button"
